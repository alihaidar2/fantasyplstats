...
// const token =
//   "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"; // Replace with your actual token



// const mysql = require('mysql2/promise');
// // const fetch = require('node-fetch'); // Only if using in a Node.js environment

// // Replace './path/to/Team' with the actual path to your Team definition
// const { Team } = require('C:\\Users\\ahaidar\\Documents\\dev\\personal\\fpl_web_app\\types\\Team.ts');
...
// async function insertTeam(team: Team, connection: Connection) {
//   const sql = `
//       INSERT INTO TEAMS (season_id, code, draw, form, id, loss, name, played, points, position, short_name, strength, team_division, unavailable, win, strength_overall_home, strength_overall_away, strength_attack_home, strength_attack_away, strength_defence_home, strength_defence_away, pulse_id)
//       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
//   `;
//   const values = [
//     2324,
...
// //   const sqlFilePath =
// //     "C:\\Users\\ahaidar\\Documents\\dev\\personal\\fpl_web_app\\queries\\create_tables.sql";
...
// //     team_a_score: fixtureData.team_a_score
// //       ? parseInt(fixtureData.team_a_score, 10)
// //       : null,
// //     team_h: parseInt(fixtureData.team_h),
// //     team_h_score: fixtureData.team_h_score
// //       ? parseInt(fixtureData.team_h_score, 10)
// //       : null,
